...
try:
    ...
    y_true = predictions.select(['heartdisease_indexed']).collect()
    ...
    eval = MulticlassClassificationEvaluator(labelCol="heartdisease_indexed", predictionCol="prediction", metricName="accuracy")
